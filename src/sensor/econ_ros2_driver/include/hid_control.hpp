 ...
 * @brief See3CAM_24CUG HID Extension Unit control.
 *
 * Sets stream mode (TRIGGER/MASTER) and exposure through the hidraw character device.
 */
...
// ─────────────────────────────────────────────────────────────
// User code only needs to call these two functions.
// The SD/HD node does not need to hold an init_hid member function.
// ─────────────────────────────────────────────────────────────
